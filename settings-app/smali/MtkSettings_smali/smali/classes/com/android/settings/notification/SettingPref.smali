...
.method public init(Lcom/android/settings/SettingsPreferenceFragment;)Landroid/support/v7/preference/Preference;
    ...
    :cond_0
    instance-of p1, v1, Landroid/support/v7/preference/TwoStatePreference;
    ...
    iput-object p1, p0, Lcom/android/settings/notification/SettingPref;->mTwoState:Landroid/support/v7/preference/TwoStatePreference;

    goto :goto_1

    .line 73
    :cond_1
    instance-of p1, v1, Landroid/support/v7/preference/DropDownPreference;
    ...
    iput-object p1, p0, Lcom/android/settings/notification/SettingPref;->mDropDown:Landroid/support/v7/preference/DropDownPreference;
    ...
    invoke-virtual {v4, p1}, Landroid/support/v7/preference/DropDownPreference;->setEntries([Ljava/lang/CharSequence;)V

    .line 82
    iget-object p1, p0, Lcom/android/settings/notification/SettingPref;->mDropDown:Landroid/support/v7/preference/DropDownPreference;

    invoke-virtual {p1, v3}, Landroid/support/v7/preference/DropDownPreference;->setEntryValues([Ljava/lang/CharSequence;)V
    ...
    .line 85
    iget-object p1, p0, Lcom/android/settings/notification/SettingPref;->mTwoState:Landroid/support/v7/preference/TwoStatePreference;
    ...
    invoke-virtual {v1, p1}, Landroid/support/v7/preference/Preference;->setOnPreferenceChangeListener(Landroid/support/v7/preference/Preference$OnPreferenceChangeListener;)V
...
.method protected setSetting(Landroid/content/Context;I)Z
    ...
    invoke-static {v0, p1, v1, p2}, Lcom/android/settings/notification/SettingPref;->putInt(ILandroid/content/ContentResolver;Ljava/lang/String;I)Z
...
.method public update(Landroid/content/Context;)V
    ...
    .line 121
    iget-object v0, p0, Lcom/android/settings/notification/SettingPref;->mTwoState:Landroid/support/v7/preference/TwoStatePreference;
    ...
    .line 123
    :cond_1
    iget-object v0, p0, Lcom/android/settings/notification/SettingPref;->mDropDown:Landroid/support/v7/preference/DropDownPreference;
    ...
    invoke-virtual {v0, p1}, Landroid/support/v7/preference/DropDownPreference;->setValue(Ljava/lang/String;)V

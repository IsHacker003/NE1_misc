...
.method private updateUi()V
    ...
    const v3, 0x7f120515    # @string/deny 'Deny'

    const v4, 0x7f1200d1    # @string/allow 'Allow'
    ...
    const v1, 0x7f1210f3    # @string/wifi_stopping 'Turning off Wi‑Fi…'
    ...
    const v3, 0x7f120fde    # @string/wifi_ask_disable '%s wants to turn off Wi-Fi'
    ...
    const v1, 0x7f1210e7    # @string/wifi_starting 'Turning Wi‑Fi on…'
    ...
    const v3, 0x7f120fdf    # @string/wifi_ask_enable '%s wants to turn on Wi-Fi'
...
.method protected onCreate(Landroid/os/Bundle;)V
    ...
    invoke-virtual {p0, p1}, Lcom/android/settings/wifi/RequestToggleWiFiActivity;->getSystemService(Ljava/lang/Class;)Ljava/lang/Object;
    ...
    invoke-virtual {p0, p1}, Lcom/android/settings/wifi/RequestToggleWiFiActivity;->setResult(I)V
    ...
    .line 85
    const-string p1, "RequestToggleWiFiActivity"

    new-instance v1, Ljava/lang/StringBuilder;

    invoke-direct {v1}, Ljava/lang/StringBuilder;-><init>()V

    const-string v2, "Couldn\'t find app with package name "

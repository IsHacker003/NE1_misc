...
.method private animateOldContent(Ljava/lang/Runnable;)V
    ...
    .line 344
    const v2, 0x10c000f    # @android:interpolator/fast_out_linear_in
...
.method private static getButtonLabel(Lcom/android/settings/TrustedCredentialsSettings$CertHolder;)I
    ...
    .line 324
    const p0, 0x7f120e08    # @string/trusted_credentials_enable_label 'Enable'

    goto :goto_0

    .line 325
    :cond_0
    const p0, 0x7f120e06    # @string/trusted_credentials_disable_label 'Disable'

    goto :goto_0

    .line 326
    :cond_1
    const p0, 0x7f120e0a    # @string/trusted_credentials_remove_label 'Remove'
...
.method private onClickEnableOrDisable()V
    ...
    const v3, 0x7f120e09    # @string/trusted_credentials_remove_confirmation 'Permanently remove the user CA certificate?'
...
.method private updatePositiveButton()V
    ...
    .line 230
    invoke-static {v1, v0}, Lcom/android/settingslib/RestrictedLockUtils;->getProfileOrDeviceOwner(Landroid/content/Context;I)Lcom/android/settingslib/RestrictedLockUtils$EnforcedAdmin;
    ...
    .line 235
    const v1, 0x7f120e0d    # @string/trusted_credentials_trust_label 'Trust'

...
.method public launch()V
    ...
    iget-object v2, v2, Lcom/android/settings/core/SubSettingLauncher$LaunchRequest;->mResultListener:Landroid/app/Fragment;
    ...
    iget v3, v3, Lcom/android/settings/core/SubSettingLauncher$LaunchRequest;->mRequestCode:I

    invoke-virtual {p0, v1, v0, v2, v3}, Lcom/android/settings/core/SubSettingLauncher;->launchForResultAsUser(Landroid/content/Intent;Landroid/os/UserHandle;Landroid/app/Fragment;I)V
    ...
    iget-object v0, v0, Lcom/android/settings/core/SubSettingLauncher$LaunchRequest;->mResultListener:Landroid/app/Fragment;

    iget-object v2, p0, Lcom/android/settings/core/SubSettingLauncher;->mLaunchRequest:Lcom/android/settings/core/SubSettingLauncher$LaunchRequest;

    iget v2, v2, Lcom/android/settings/core/SubSettingLauncher$LaunchRequest;->mRequestCode:I

    invoke-direct {p0, v0, v1, v2}, Lcom/android/settings/core/SubSettingLauncher;->launchForResult(Landroid/app/Fragment;Landroid/content/Intent;I)V
...
.method launchForResultAsUser(Landroid/content/Intent;Landroid/os/UserHandle;Landroid/app/Fragment;I)V
    ...
    invoke-virtual {p3, p1, p4, p2}, Landroid/app/Activity;->startActivityForResultAsUser(Landroid/content/Intent;ILandroid/os/UserHandle;)V
...
.method public setResultListener(Landroid/app/Fragment;I)Lcom/android/settings/core/SubSettingLauncher;
    ...
    .line 84
    iget-object p2, p0, Lcom/android/settings/core/SubSettingLauncher;->mLaunchRequest:Lcom/android/settings/core/SubSettingLauncher$LaunchRequest;

    iput-object p1, p2, Lcom/android/settings/core/SubSettingLauncher$LaunchRequest;->mResultListener:Landroid/app/Fragment;
...
.method public setTitle(Ljava/lang/String;I)Lcom/android/settings/core/SubSettingLauncher;
    ...
    .line 57
    iget-object p1, p0, Lcom/android/settings/core/SubSettingLauncher;->mLaunchRequest:Lcom/android/settings/core/SubSettingLauncher$LaunchRequest;

    iput p2, p1, Lcom/android/settings/core/SubSettingLauncher$LaunchRequest;->titleResId:I
    ...
    iput-object p2, p1, Lcom/android/settings/core/SubSettingLauncher$LaunchRequest;->title:Ljava/lang/CharSequence;

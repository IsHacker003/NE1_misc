...
.method static synthetic access$100(Lcom/android/settings/inputmethod/PhysicalKeyboardFragment;)Lcom/android/internal/inputmethod/InputMethodUtils$InputMethodSettings;
    ...
    .line 58
    iget-object p0, p0, Lcom/android/settings/inputmethod/PhysicalKeyboardFragment;->mSettings:Lcom/android/internal/inputmethod/InputMethodUtils$InputMethodSettings;
...
.method static getHardKeyboards(Landroid/content/Context;)Ljava/util/List;
    ...
    .line 290
    new-instance v1, Lcom/android/settings/inputmethod/-$$Lambda$PhysicalKeyboardFragment$E1Pa9yi7mSTmfiefFBHYeSOZEJQ;

    invoke-direct {v1, p0}, Lcom/android/settings/inputmethod/-$$Lambda$PhysicalKeyboardFragment$E1Pa9yi7mSTmfiefFBHYeSOZEJQ;-><init>(Ljava/text/Collator;)V
...
.method private static getLayoutLabel(Landroid/view/InputDevice;Landroid/content/Context;Landroid/hardware/input/InputManager;)Ljava/lang/String;
    ...
    .line 260
    const v0, 0x7f120777    # @string/keyboard_layout_default_label 'Default'
...
.method private showKeyboardLayoutDialog(Landroid/hardware/input/InputDeviceIdentifier;)V
    ...
    invoke-virtual {v0, p0, p1}, Lcom/android/settings/inputmethod/KeyboardLayoutDialogFragment;->setTargetFragment(Landroid/app/Fragment;I)V
    ...
    invoke-virtual {v0, p1, v1}, Lcom/android/settings/inputmethod/KeyboardLayoutDialogFragment;->show(Landroid/app/FragmentManager;Ljava/lang/String;)V
...
.method private updateHardKeyboards(Ljava/util/List;)V
    ...
    .line 168
    const v2, 0x7f12034d    # @string/builtin_keyboard_settings_title 'Physical keyboard'
    ...
    .line 177
    new-instance v4, Lcom/android/settings/inputmethod/-$$Lambda$PhysicalKeyboardFragment$GzAuWQoIrNRWOGdhye1KALY7EFw;

    invoke-direct {v4, p0, v2}, Lcom/android/settings/inputmethod/-$$Lambda$PhysicalKeyboardFragment$GzAuWQoIrNRWOGdhye1KALY7EFw;-><init>(Lcom/android/settings/inputmethod/PhysicalKeyboardFragment;Lcom/android/settings/inputmethod/PhysicalKeyboardFragment$HardKeyboardDeviceInfo;)V
    ...
    .line 184
    :cond_1
    iget-object p1, p0, Lcom/android/settings/inputmethod/PhysicalKeyboardFragment;->mKeyboardAssistanceCategory:Landroid/support/v7/preference/PreferenceCategory;

    const/4 v1, 0x1

    invoke-virtual {p1, v1}, Landroid/support/v7/preference/PreferenceCategory;->setOrder(I)V
...
.method public onCreatePreferences(Landroid/os/Bundle;Ljava/lang/String;)V
    ...
    .line 82
    const p2, 0x7f15007a    # @xml/physical_keyboard_settings 'res/xml/physical_keyboard_settings.xml'
    ...
    iput-object p2, p0, Lcom/android/settings/inputmethod/PhysicalKeyboardFragment;->mIm:Landroid/hardware/input/InputManager;

    .line 84
    new-instance p2, Lcom/android/internal/inputmethod/InputMethodUtils$InputMethodSettings;
    ...
    iput-object p2, p0, Lcom/android/settings/inputmethod/PhysicalKeyboardFragment;->mSettings:Lcom/android/internal/inputmethod/InputMethodUtils$InputMethodSettings;

    .line 91
    const-string p1, "keyboard_assistance_category"

    .line 92
    invoke-virtual {p0, p1}, Lcom/android/settings/inputmethod/PhysicalKeyboardFragment;->findPreference(Ljava/lang/CharSequence;)Landroid/support/v7/preference/Preference;
    ...
    iput-object p1, p0, Lcom/android/settings/inputmethod/PhysicalKeyboardFragment;->mKeyboardAssistanceCategory:Landroid/support/v7/preference/PreferenceCategory;
    ...
    iput-object p1, p0, Lcom/android/settings/inputmethod/PhysicalKeyboardFragment;->mShowVirtualKeyboardSwitch:Landroid/support/v14/preference/SwitchPreference;

...
.method private rebuildAppList(Landroid/support/v7/preference/PreferenceGroup;Ljava/util/ArrayList;)V
    ...
    iget-object v6, p0, Lcom/android/settings/applications/ManageDomainUrls;->mApplicationsState:Lcom/android/settingslib/applications/ApplicationsState;

    invoke-direct {v4, v5, v6, v2}, Lcom/android/settings/applications/ManageDomainUrls$DomainAppPreference;-><init>(Landroid/content/Context;Lcom/android/settingslib/applications/ApplicationsState;Lcom/android/settingslib/applications/ApplicationsState$AppEntry;)V
...
.method protected getPreferenceScreenResId()I
    ...
    .line 76
    const v0, 0x7f15006c    # @xml/manage_domain_url_settings 'res/xml/manage_domain_url_settings.xml'
...
.method public onCreate(Landroid/os/Bundle;)V
    ...
    invoke-virtual {p0, p1}, Lcom/android/settings/applications/ManageDomainUrls;->setAnimationAllowed(Z)V
    ...
    .line 71
    invoke-virtual {p0, p1}, Lcom/android/settings/applications/ManageDomainUrls;->setHasOptionsMenu(Z)V
...
.method public onPreferenceClick(Landroid/support/v7/preference/Preference;)Z
    ...
    invoke-static {p1}, Lcom/android/settings/applications/ManageDomainUrls$DomainAppPreference;->access$000(Lcom/android/settings/applications/ManageDomainUrls$DomainAppPreference;)Lcom/android/settingslib/applications/ApplicationsState$AppEntry;
    ...
    const v1, 0x7f12018f    # @string/auto_launch_label 'Open by default'
...
.method public onRebuildComplete(Ljava/util/ArrayList;)V
    ...
    iput-object v0, p0, Lcom/android/settings/applications/ManageDomainUrls;->mDomainAppList:Landroid/support/v7/preference/PreferenceGroup;
    ...
    .line 108
    const v4, 0x7f120fa0    # @string/web_action_section_title 'Instant apps'

    invoke-virtual {v3, v4}, Landroid/support/v7/preference/PreferenceCategory;->setTitle(I)V

    .line 109
    invoke-virtual {v0, v3}, Landroid/support/v7/preference/PreferenceGroup;->addPreference(Landroid/support/v7/preference/Preference;)Z
    ...
    iput-object v4, p0, Lcom/android/settings/applications/ManageDomainUrls;->mWebAction:Landroid/support/v14/preference/SwitchPreference;

    .line 113
    iget-object v4, p0, Lcom/android/settings/applications/ManageDomainUrls;->mWebAction:Landroid/support/v14/preference/SwitchPreference;

    const v5, 0x7f120f9f    # @string/web_action_enable_title 'Instant apps'

    invoke-virtual {v4, v5}, Landroid/support/v14/preference/SwitchPreference;->setTitle(I)V

    .line 114
    iget-object v4, p0, Lcom/android/settings/applications/ManageDomainUrls;->mWebAction:Landroid/support/v14/preference/SwitchPreference;

    const v5, 0x7f120f9e    # @string/web_action_enable_summary 'Open links in apps, even if they’re not installed'
    ...
    const-string v6, "instant_apps_enabled"
    ...
    iput-object v1, p0, Lcom/android/settings/applications/ManageDomainUrls;->mInstantAppAccountPreference:Landroid/support/v7/preference/Preference;

    .line 132
    iget-object v1, p0, Lcom/android/settings/applications/ManageDomainUrls;->mInstantAppAccountPreference:Landroid/support/v7/preference/Preference;

    const v4, 0x7f12075c    # @string/instant_apps_settings 'Instant Apps preferences'
    ...
    new-instance v4, Lcom/android/settings/applications/-$$Lambda$ManageDomainUrls$agHbI5vf9m7UaPnJCYH2ithkZhk;

    invoke-direct {v4, p0, v2}, Lcom/android/settings/applications/-$$Lambda$ManageDomainUrls$agHbI5vf9m7UaPnJCYH2ithkZhk;-><init>(Lcom/android/settings/applications/ManageDomainUrls;Landroid/content/Intent;)V
    ...
    const v2, 0x7f120594    # @string/domain_url_section_title 'Installed apps'

    invoke-virtual {v1, v2}, Landroid/support/v7/preference/PreferenceGroup;->setTitle(I)V
    ...
    :cond_6
    :goto_1
    iget-object v0, p0, Lcom/android/settings/applications/ManageDomainUrls;->mDomainAppList:Landroid/support/v7/preference/PreferenceGroup;

    invoke-direct {p0, v0, p1}, Lcom/android/settings/applications/ManageDomainUrls;->rebuildAppList(Landroid/support/v7/preference/PreferenceGroup;Ljava/util/ArrayList;)V

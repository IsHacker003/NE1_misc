...
.method private updateHistPrefSummary(Landroid/content/Context;)V
    ...
    .line 160
    invoke-interface {v0}, Lcom/android/settings/fuelgauge/PowerUsageFeatureProvider;->getAdvancedUsageScreenInfoString()Ljava/lang/String;

    move-result-object v0

    .line 159
    invoke-virtual {p1, v0}, Lcom/android/settings/fuelgauge/BatteryHistoryPreference;->setBottomSummary(Ljava/lang/CharSequence;)V
    ...
    invoke-virtual {p1}, Lcom/android/settings/fuelgauge/BatteryHistoryPreference;->hideBottomSummary()V
...
.method protected getPreferenceScreenResId()I
    ...
    .line 91
    const v0, 0x7f150080    # @xml/power_usage_advanced 'res/xml/power_usage_advanced.xml'
...
.method public onCreateOptionsMenu(Landroid/view/Menu;Landroid/view/MenuInflater;)V
    ...
    const v0, 0x7f120722    # @string/hide_extra_apps 'Show app usage'

    goto :goto_0

    :cond_0
    const v0, 0x7f120c49    # @string/show_all_apps 'Show full device usage'
...
.method public onOptionsItemSelected(Landroid/view/MenuItem;)Z
    ...
    .line 107
    iget-object p1, p0, Lcom/android/settings/fuelgauge/PowerUsageAdvanced;->mMetricsFeatureProvider:Lcom/android/settingslib/core/instrumentation/MetricsFeatureProvider;
    ...
    invoke-virtual {p0, p1}, Lcom/android/settings/fuelgauge/PowerUsageAdvanced;->restartBatteryStatsLoader(I)V
...
.method protected refreshUi(I)V
    ...
    invoke-virtual {p0, v0}, Lcom/android/settings/fuelgauge/PowerUsageAdvanced;->updatePreference(Lcom/android/settings/fuelgauge/BatteryHistoryPreference;)V
    ...
    iget-object v0, p0, Lcom/android/settings/fuelgauge/PowerUsageAdvanced;->mStatsHelper:Lcom/android/internal/os/BatteryStatsHelper;

    iget-boolean v1, p0, Lcom/android/settings/fuelgauge/PowerUsageAdvanced;->mShowAllApps:Z

    invoke-virtual {p1, v0, v1}, Lcom/android/settings/fuelgauge/BatteryAppListPreferenceController;->refreshAppListGroup(Lcom/android/internal/os/BatteryStatsHelper;Z)V

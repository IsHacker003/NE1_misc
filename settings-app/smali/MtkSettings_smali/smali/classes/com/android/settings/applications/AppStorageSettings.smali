...
.method private clearUriPermissions()V
    ...
    const-string v3, "com.android.documentsui.scopedAccess"
    ...
    const-string v5, "Asking "

    invoke-virtual {v4, v5}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    invoke-virtual {v4, v2}, Ljava/lang/StringBuilder;->append(Ljava/lang/Object;)Ljava/lang/StringBuilder;

    const-string v5, " to delete permissions for "
    ...
    const-string v0, " entries for package "
...
.method private initDataButtons()V
    ...
    :goto_4
    const v4, 0x7f1203b4    # @string/clear_user_data_text 'Clear storage'
    ...
    .line 316
    invoke-virtual {v0, v4}, Lcom/android/settings/widget/ActionButtonPreference;->setButton1Text(I)Lcom/android/settings/widget/ActionButtonPreference;
    ...
    const v1, 0x7f1208a0    # @string/manage_space_text 'Manage space'
...
.method private initMoveDialog()V
    ...
    const v1, 0x7f12039b    # @string/change_storage 'Change storage'
...
.method private initiateClearUserData()V
    ...
    invoke-virtual {p0, v0, v2}, Lcom/android/settings/applications/AppStorageSettings;->showDialogInner(II)V
    ...
    const v1, 0x7f120b18    # @string/recompute_size 'Recomputing size…'
...
.method private processClearMsg(Landroid/os/Message;)V
    ...
    const v2, 0x7f1203b4    # @string/clear_user_data_text 'Clear storage'
    ...
    .line 407
    :cond_0
    iget-object p1, p0, Lcom/android/settings/applications/AppStorageSettings;->mButtonsPref:Lcom/android/settings/widget/ActionButtonPreference;

    invoke-virtual {p1, v1}, Lcom/android/settings/widget/ActionButtonPreference;->setButton1Enabled(Z)Lcom/android/settings/widget/ActionButtonPreference;
...
.method private refreshGrantedUriPermissions()V
    ...
    invoke-direct {v3, v6}, Landroid/support/v7/preference/Preference;-><init>(Landroid/content/Context;)V
    ...
    const v6, 0x7f10003f    # @plurals/uri_permissions_text
    ...
    .line 452
    const v1, 0x7f0d00a7    # @layout/horizontal_preference 'res/layout/horizontal_preference.xml'

    invoke-virtual {v3, v1}, Landroid/support/v7/preference/Preference;->setLayoutResource(I)V

    .line 453
    invoke-virtual {v3, v5}, Landroid/support/v7/preference/Preference;->setOrder(I)V
    ...
    invoke-virtual {v0, v5}, Lcom/android/settings/applications/LayoutPreference;->setOrder(I)V
...
.method private setupViews()V
    ...
    .line 178
    const v1, 0x7f120769    # @string/invalid_size_value 'Couldn’t compute package size.'
    ...
    const v2, 0x7f12039a    # @string/change 'Change'
    ...
    const v2, 0x7f1203ac    # @string/clear_cache_btn_text 'Clear cache'
    ...
    const v1, 0x7f1203b3    # @string/clear_uri_btn_text 'Clear access'
...
.method protected createDialog(II)Landroid/app/AlertDialog;
    ...
    const v1, 0x7f1203b4    # @string/clear_user_data_text 'Clear storage'
    ...
    const v1, 0x7f1203af    # @string/clear_failed_dlg_text 'Couldn’t clear storage for app.'
    ...
    const v2, 0x7f1203ae    # @string/clear_data_dlg_title 'Delete app data?'
    ...
    const v2, 0x7f1203ad    # @string/clear_data_dlg_text 'All this app’s data will be deleted permanently. This includes all files, settings, accounts, databa ...'
...
.method public onClick(Landroid/view/View;)V
    ...
    .line 235
    iget-object p1, p0, Lcom/android/settings/applications/AppStorageSettings;->mDialogBuilder:Landroid/app/AlertDialog$Builder;
    ...
    .line 237
    iget-object p1, p0, Lcom/android/settings/applications/AppStorageSettings;->mAppsControlDisallowedAdmin:Lcom/android/settingslib/RestrictedLockUtils$EnforcedAdmin;

    if-eqz p1, :cond_1

    iget-boolean p1, p0, Lcom/android/settings/applications/AppStorageSettings;->mAppsControlDisallowedBySystem:Z
...
.method public onCreate(Landroid/os/Bundle;)V
    ...
    .line 152
    :cond_2
    const p1, 0x7f15001c    # @xml/app_storage_settings 'res/xml/app_storage_settings.xml'
...
.method public onCreateLoader(ILandroid/os/Bundle;)Landroid/content/Loader;
    ...
    invoke-direct {p2, p1, v0, v1, v2}, Lcom/android/settings/applications/FetchPackageStorageAsyncLoader;-><init>(Landroid/content/Context;Lcom/android/settingslib/applications/StorageStatsSource;Landroid/content/pm/ApplicationInfo;Landroid/os/UserHandle;)V
...
.method updateUiWithSize(Lcom/android/settingslib/applications/StorageStatsSource$AppStorageStats;)V
    ...
    invoke-virtual {p1, v0}, Lcom/android/settings/widget/ActionButtonPreference;->setButton1Enabled(Z)Lcom/android/settings/widget/ActionButtonPreference;
    ...
    .line 589
    invoke-virtual {p1, v4}, Lcom/android/settings/widget/ActionButtonPreference;->setButton1OnClickListener(Landroid/view/View$OnClickListener;)Lcom/android/settings/widget/ActionButtonPreference;
    ...
    invoke-virtual {p1, v1}, Lcom/android/settings/widget/ActionButtonPreference;->setButton2Enabled(Z)Lcom/android/settings/widget/ActionButtonPreference;
    ...
    .line 595
    invoke-virtual {p1, v1}, Lcom/android/settings/widget/ActionButtonPreference;->setButton2OnClickListener(Landroid/view/View$OnClickListener;)Lcom/android/settings/widget/ActionButtonPreference;

...
.method public static forceCustomPadding(Landroid/view/View;Z)V
    ...
    .line 302
    const v1, 0x7f070136    # @dimen/settings_side_margin '0.0dp'
    ...
    .line 306
    const p1, 0x105016c    # @android:dimen/preference_fragment_padding_bottom
    ...
    .line 309
    invoke-virtual {p0, v3, v2, v1, p1}, Landroid/view/View;->setPaddingRelative(IIII)V
...
.method public static getAdminApplicationInfo(Landroid/content/Context;I)Landroid/content/pm/ApplicationInfo;
    ...
    const-string v4, "Error while retrieving application info for package "
...
.method public static getHardWareId()Ljava/lang/String;
    ...
    const-string v1, "getHardWareId : Exception BufferedReader error"
    ...
    const-string v3, "getHardWareId hwID = "
...
.method public static getInstallationStatus(Landroid/content/pm/ApplicationInfo;)I
    ...
    .line 903
    const p0, 0x7f120991    # @string/not_installed 'Not installed for this user'
    ...
    const p0, 0x7f12075a    # @string/installed 'Installed'

    goto :goto_0

    :cond_1
    const p0, 0x7f12054d    # @string/disabled 'Disabled'
...
.method public static inflateCategoryHeader(Landroid/view/LayoutInflater;Landroid/view/ViewGroup;)Landroid/view/View;
    ...
    const v4, 0x101008c    # @android:attr/preferenceCategoryStyle
...
.method public static isSIM2PhoneRingtoneEnable(Landroid/content/Context;)Z
    .locals 4
    ...
    const-string v3, "telephony.isMultiSimEnabled(): "
    ...
    const-string v3, "telephony.isVoiceCapable(): "
...
.method public static prepareCustomPreferencesList(Landroid/view/ViewGroup;Landroid/view/View;Landroid/view/View;Z)V
    ...
    .line 285
    const v3, 0x7f070136    # @dimen/settings_side_margin '0.0dp'
    ...
    .line 286
    const v4, 0x105016c    # @android:dimen/preference_fragment_padding_bottom
...
.method public static updatePreferenceToSpecificActivityOrRemove(Landroid/content/Context;Landroid/support/v7/preference/PreferenceGroup;Ljava/lang/String;I)Z
    ...
    .line 155
    :cond_0
    invoke-virtual {p2}, Landroid/support/v7/preference/Preference;->getIntent()Landroid/content/Intent;
    ...
    invoke-virtual {p2, p1}, Landroid/support/v7/preference/Preference;->setIntent(Landroid/content/Intent;)V
    ...
    invoke-virtual {p2, p0}, Landroid/support/v7/preference/Preference;->setTitle(Ljava/lang/CharSequence;)V

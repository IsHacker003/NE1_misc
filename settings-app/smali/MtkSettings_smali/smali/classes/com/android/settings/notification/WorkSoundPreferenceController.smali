...
.method private enableWorkSyncSettings()V
    ...
    const v1, 0x7f121129    # @string/work_sound_same_as_personal 'Same as personal profile'
...
.method private initWorkPreference(Landroid/support/v7/preference/PreferenceGroup;Ljava/lang/String;)Lcom/android/settings/DefaultRingtonePreference;
    ...
    .line 185
    invoke-virtual {p1, p0}, Lcom/android/settings/DefaultRingtonePreference;->setOnPreferenceChangeListener(Landroid/support/v7/preference/Preference$OnPreferenceChangeListener;)V

    .line 188
    iget p2, p0, Lcom/android/settings/notification/WorkSoundPreferenceController;->mManagedProfileId:I

    invoke-virtual {p1, p2}, Lcom/android/settings/DefaultRingtonePreference;->setUserId(I)V
...
.method public static synthetic lambda$updateWorkPreferences$0(Lcom/android/settings/notification/WorkSoundPreferenceController;Landroid/support/v7/preference/Preference;Ljava/lang/Object;)Z
    ...
    .line 206
    iget-object p1, p0, Lcom/android/settings/notification/WorkSoundPreferenceController;->mParent:Lcom/android/settings/notification/SoundSettings;

    invoke-static {p1}, Lcom/android/settings/notification/WorkSoundPreferenceController$UnifyWorkDialogFragment;->show(Lcom/android/settings/notification/SoundSettings;)V
...
.method private updateRingtoneName(Landroid/content/Context;I)Ljava/lang/CharSequence;
    ...
    const p2, 0x7f1208aa    # @string/managed_profile_not_available_label 'Work profile isn’t available yet'
...
.method private updateWorkPreferences()V
    ...
    iput-object v0, p0, Lcom/android/settings/notification/WorkSoundPreferenceController;->mWorkUsePersonalSounds:Landroid/support/v7/preference/TwoStatePreference;

    .line 204
    iget-object v0, p0, Lcom/android/settings/notification/WorkSoundPreferenceController;->mWorkUsePersonalSounds:Landroid/support/v7/preference/TwoStatePreference;

    new-instance v1, Lcom/android/settings/notification/-$$Lambda$WorkSoundPreferenceController$XBbO1oM_StZ54wAnUJEnnExa5OU;

    invoke-direct {v1, p0}, Lcom/android/settings/notification/-$$Lambda$WorkSoundPreferenceController$XBbO1oM_StZ54wAnUJEnnExa5OU;-><init>(Lcom/android/settings/notification/WorkSoundPreferenceController;)V
    ...
    invoke-direct {p0, v0, v1}, Lcom/android/settings/notification/WorkSoundPreferenceController;->initWorkPreference(Landroid/support/v7/preference/PreferenceGroup;Ljava/lang/String;)Lcom/android/settings/DefaultRingtonePreference;

    move-result-object v0

    iput-object v0, p0, Lcom/android/settings/notification/WorkSoundPreferenceController;->mWorkPhoneRingtonePreference:Landroid/support/v7/preference/Preference;
    ...
    iput-object v0, p0, Lcom/android/settings/notification/WorkSoundPreferenceController;->mWorkNotificationRingtonePreference:Landroid/support/v7/preference/Preference;
    ...
    iput-object v0, p0, Lcom/android/settings/notification/WorkSoundPreferenceController;->mWorkAlarmRingtonePreference:Landroid/support/v7/preference/Preference;
    ...
    iget v3, p0, Lcom/android/settings/notification/WorkSoundPreferenceController;->mManagedProfileId:I
...
.method public displayPreference(Landroid/support/v7/preference/PreferenceScreen;)V
    ...
    iput-object p1, p0, Lcom/android/settings/notification/WorkSoundPreferenceController;->mWorkPreferenceCategory:Landroid/support/v7/preference/PreferenceGroup;

    .line 100
    iget-object p1, p0, Lcom/android/settings/notification/WorkSoundPreferenceController;->mWorkPreferenceCategory:Landroid/support/v7/preference/PreferenceGroup;

...
.method private onRegionZoneChanged(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-direct {p0, p1, p2}, Lcom/android/settings/datetime/timezone/TimeZoneSettings;->setDisplayedTimeZoneInfo(Ljava/lang/String;Ljava/lang/String;)V

    .line 239
    iget-object p2, p0, Lcom/android/settings/datetime/timezone/TimeZoneSettings;->mSelectedTimeZoneId:Ljava/lang/String;

    invoke-direct {p0, p1, p2}, Lcom/android/settings/datetime/timezone/TimeZoneSettings;->saveTimeZone(Ljava/lang/String;Ljava/lang/String;)V
    ...
    const-string v1, "Unknown time zone id is selected: "
...
.method private saveTimeZone(Ljava/lang/String;Ljava/lang/String;)V
    ...
    .line 257
    const-string p1, "time_zone_region"
...
.method private setDisplayedFixedOffsetTimeZoneInfo(Ljava/lang/String;)V
    ...
    invoke-virtual {p0, p1}, Lcom/android/settings/datetime/timezone/TimeZoneSettings;->use(Ljava/lang/Class;)Lcom/android/settingslib/core/AbstractPreferenceController;
...
.method private startPickerFragment(Ljava/lang/Class;Landroid/os/Bundle;I)V
    ...
    .line 194
    invoke-virtual {p1, p0, p3}, Lcom/android/settings/core/SubSettingLauncher;->setResultListener(Landroid/app/Fragment;I)Lcom/android/settings/core/SubSettingLauncher;
...
.method public createPreferenceControllers(Landroid/content/Context;)Ljava/util/List;
    ...
    invoke-virtual {v3, p1}, Lcom/android/settings/datetime/timezone/FixedOffsetPreferenceController;->setOnClickListener(Lcom/android/settings/datetime/timezone/OnPreferenceClickListener;)V
...
.method protected getPreferenceScreenResId()I
    ...
    .line 82
    const v0, 0x7f1500a9    # @xml/time_zone_prefs 'res/xml/time_zone_prefs.xml'
...
.method public onActivityResult(IILandroid/content/Intent;)V
    ...
    .line 138
    :pswitch_1
    const-string p1, "com.android.settings.datetime.timezone.result_region_id"
    ...
    .line 139
    const-string p2, "com.android.settings.datetime.timezone.result_time_zone_id"
    ...
    .line 141
    const-class p3, Lcom/android/settings/datetime/timezone/RegionPreferenceController;

    invoke-virtual {p0, p3}, Lcom/android/settings/datetime/timezone/TimeZoneSettings;->use(Ljava/lang/Class;)Lcom/android/settingslib/core/AbstractPreferenceController;

    move-result-object p3

    check-cast p3, Lcom/android/settings/datetime/timezone/RegionPreferenceController;

    invoke-virtual {p3}, Lcom/android/settings/datetime/timezone/RegionPreferenceController;->getRegionId()Ljava/lang/String;
    ...
    iget-object p3, p0, Lcom/android/settings/datetime/timezone/TimeZoneSettings;->mSelectedTimeZoneId:Ljava/lang/String;
    ...
    .line 143
    :cond_1
    invoke-direct {p0, p1, p2}, Lcom/android/settings/datetime/timezone/TimeZoneSettings;->onRegionZoneChanged(Ljava/lang/String;Ljava/lang/String;)V
...
.method public onCreate(Landroid/os/Bundle;)V
    ...
    invoke-virtual {p0, p1}, Lcom/android/settings/datetime/timezone/TimeZoneSettings;->findPreference(Ljava/lang/CharSequence;)Landroid/support/v7/preference/Preference;
    ...
    invoke-direct {p0, p1, v0}, Lcom/android/settings/datetime/timezone/TimeZoneSettings;->setPreferenceCategoryVisible(Landroid/support/v7/preference/PreferenceCategory;Z)V
...
.method public onCreateOptionsMenu(Landroid/view/Menu;Landroid/view/MenuInflater;)V
    ...
    const v2, 0x7f121205    # @string/zone_menu_by_region 'Select by region'
    ...
    const v2, 0x7f121204    # @string/zone_menu_by_offset 'Select by UTC offset'

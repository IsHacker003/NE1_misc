...
.method private constructor <init>(Lcom/android/settings/fuelgauge/anomaly/Anomaly$Builder;)V
    ...
    iput p1, p0, Lcom/android/settings/fuelgauge/anomaly/Anomaly;->wakeupAlarmCount:I
...
.method private toAnomalyTypeText(I)Ljava/lang/String;
    ...
    .line 169
    :pswitch_0
    const-string p1, "unoptimizedBluetoothScan"

    return-object p1

    .line 165
    :pswitch_1
    const-string p1, "wakeupAlarm"
...
.method public equals(Ljava/lang/Object;)Z
    ...
    iget v3, p1, Lcom/android/settings/fuelgauge/anomaly/Anomaly;->type:I

    if-ne v1, v3, :cond_2

    iget v1, p0, Lcom/android/settings/fuelgauge/anomaly/Anomaly;->uid:I

    iget v3, p1, Lcom/android/settings/fuelgauge/anomaly/Anomaly;->uid:I

    if-ne v1, v3, :cond_2

    iget-wide v3, p0, Lcom/android/settings/fuelgauge/anomaly/Anomaly;->wakelockTimeMs:J

    iget-wide v5, p1, Lcom/android/settings/fuelgauge/anomaly/Anomaly;->wakelockTimeMs:J
    ...
    iget-object v3, p1, Lcom/android/settings/fuelgauge/anomaly/Anomaly;->displayName:Ljava/lang/CharSequence;
    ...
    iget v3, p1, Lcom/android/settings/fuelgauge/anomaly/Anomaly;->targetSdkVersion:I

    if-ne v1, v3, :cond_2

    iget-boolean v1, p0, Lcom/android/settings/fuelgauge/anomaly/Anomaly;->backgroundRestrictionEnabled:Z

    iget-boolean v3, p1, Lcom/android/settings/fuelgauge/anomaly/Anomaly;->backgroundRestrictionEnabled:Z

    if-ne v1, v3, :cond_2

    iget v1, p0, Lcom/android/settings/fuelgauge/anomaly/Anomaly;->wakeupAlarmCount:I

    iget v3, p1, Lcom/android/settings/fuelgauge/anomaly/Anomaly;->wakeupAlarmCount:I

    if-ne v1, v3, :cond_2

    iget-wide v3, p0, Lcom/android/settings/fuelgauge/anomaly/Anomaly;->bluetoothScanningTimeMs:J

    iget-wide v5, p1, Lcom/android/settings/fuelgauge/anomaly/Anomaly;->bluetoothScanningTimeMs:J
...
.method public writeToParcel(Landroid/os/Parcel;I)V
    ...
    .line 116
    iget p2, p0, Lcom/android/settings/fuelgauge/anomaly/Anomaly;->type:I

    invoke-virtual {p1, p2}, Landroid/os/Parcel;->writeInt(I)V

    .line 117
    iget p2, p0, Lcom/android/settings/fuelgauge/anomaly/Anomaly;->uid:I

    invoke-virtual {p1, p2}, Landroid/os/Parcel;->writeInt(I)V

    .line 118
    iget-object p2, p0, Lcom/android/settings/fuelgauge/anomaly/Anomaly;->displayName:Ljava/lang/CharSequence;

    invoke-virtual {p1, p2}, Landroid/os/Parcel;->writeCharSequence(Ljava/lang/CharSequence;)V

    .line 119
    iget-object p2, p0, Lcom/android/settings/fuelgauge/anomaly/Anomaly;->packageName:Ljava/lang/String;
    ...
    .line 121
    iget p2, p0, Lcom/android/settings/fuelgauge/anomaly/Anomaly;->targetSdkVersion:I

    invoke-virtual {p1, p2}, Landroid/os/Parcel;->writeInt(I)V

    .line 122
    iget-boolean p2, p0, Lcom/android/settings/fuelgauge/anomaly/Anomaly;->backgroundRestrictionEnabled:Z

    invoke-virtual {p1, p2}, Landroid/os/Parcel;->writeBoolean(Z)V

    .line 123
    iget p2, p0, Lcom/android/settings/fuelgauge/anomaly/Anomaly;->wakeupAlarmCount:I

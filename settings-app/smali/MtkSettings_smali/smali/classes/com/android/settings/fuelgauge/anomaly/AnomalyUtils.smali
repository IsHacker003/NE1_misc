...
.method constructor <init>(Landroid/content/Context;)V
    ...
    iput-object p1, p0, Lcom/android/settings/fuelgauge/anomaly/AnomalyUtils;->mContext:Landroid/content/Context;
...
.method public static getInstance(Landroid/content/Context;)Lcom/android/settings/fuelgauge/anomaly/AnomalyUtils;
    ...
    .line 67
    :cond_0
    sget-object p0, Lcom/android/settings/fuelgauge/anomaly/AnomalyUtils;->sInstance:Lcom/android/settings/fuelgauge/anomaly/AnomalyUtils;
...
.method public detectAnomalies(Lcom/android/internal/os/BatteryStatsHelper;Lcom/android/settings/fuelgauge/anomaly/AnomalyDetectionPolicy;Ljava/lang/String;)Ljava/util/List;
    ...
    invoke-interface {v4, p1, p3}, Lcom/android/settings/fuelgauge/anomaly/checker/AnomalyDetector;->detectAnomalies(Lcom/android/internal/os/BatteryStatsHelper;Ljava/lang/String;)Ljava/util/List;
...
.method public getAnomalyAction(Lcom/android/settings/fuelgauge/anomaly/Anomaly;)Lcom/android/settings/fuelgauge/anomaly/action/AnomalyAction;
    ...
    .line 89
    :pswitch_0
    new-instance p1, Lcom/android/settings/fuelgauge/anomaly/action/LocationCheckAction;

    iget-object v0, p0, Lcom/android/settings/fuelgauge/anomaly/AnomalyUtils;->mContext:Landroid/content/Context;

    invoke-direct {p1, v0}, Lcom/android/settings/fuelgauge/anomaly/action/LocationCheckAction;-><init>(Landroid/content/Context;)V
    ...
    iget-boolean p1, p1, Lcom/android/settings/fuelgauge/anomaly/Anomaly;->backgroundRestrictionEnabled:Z
    ...
    .line 86
    :cond_0
    new-instance p1, Lcom/android/settings/fuelgauge/anomaly/action/StopAndBackgroundCheckAction;

    iget-object v0, p0, Lcom/android/settings/fuelgauge/anomaly/AnomalyUtils;->mContext:Landroid/content/Context;

    invoke-direct {p1, v0}, Lcom/android/settings/fuelgauge/anomaly/action/StopAndBackgroundCheckAction;-><init>(Landroid/content/Context;)V
    ...
    :cond_1
    :goto_0
    new-instance p1, Lcom/android/settings/fuelgauge/anomaly/action/ForceStopAction;

    iget-object v0, p0, Lcom/android/settings/fuelgauge/anomaly/AnomalyUtils;->mContext:Landroid/content/Context;

    invoke-direct {p1, v0}, Lcom/android/settings/fuelgauge/anomaly/action/ForceStopAction;-><init>(Landroid/content/Context;)V
...
.method public getAnomalyDetector(I)Lcom/android/settings/fuelgauge/anomaly/checker/AnomalyDetector;
    ...
    .line 108
    :pswitch_0
    new-instance p1, Lcom/android/settings/fuelgauge/anomaly/checker/BluetoothScanAnomalyDetector;

    iget-object v0, p0, Lcom/android/settings/fuelgauge/anomaly/AnomalyUtils;->mContext:Landroid/content/Context;

    invoke-direct {p1, v0}, Lcom/android/settings/fuelgauge/anomaly/checker/BluetoothScanAnomalyDetector;-><init>(Landroid/content/Context;)V

    return-object p1

    .line 106
    :pswitch_1
    new-instance p1, Lcom/android/settings/fuelgauge/anomaly/checker/WakeupAlarmAnomalyDetector;

    iget-object v0, p0, Lcom/android/settings/fuelgauge/anomaly/AnomalyUtils;->mContext:Landroid/content/Context;

    invoke-direct {p1, v0}, Lcom/android/settings/fuelgauge/anomaly/checker/WakeupAlarmAnomalyDetector;-><init>(Landroid/content/Context;)V

    return-object p1

    .line 104
    :pswitch_2
    new-instance p1, Lcom/android/settings/fuelgauge/anomaly/checker/WakeLockAnomalyDetector;

    iget-object v0, p0, Lcom/android/settings/fuelgauge/anomaly/AnomalyUtils;->mContext:Landroid/content/Context;

    invoke-direct {p1, v0}, Lcom/android/settings/fuelgauge/anomaly/checker/WakeLockAnomalyDetector;-><init>(Landroid/content/Context;)V
...
.method public logAnomaly(Lcom/android/settingslib/core/instrumentation/MetricsFeatureProvider;Lcom/android/settings/fuelgauge/anomaly/Anomaly;I)V
    ...
    invoke-virtual {p2}, Lcom/android/settings/fuelgauge/anomaly/action/AnomalyAction;->getActionType()I

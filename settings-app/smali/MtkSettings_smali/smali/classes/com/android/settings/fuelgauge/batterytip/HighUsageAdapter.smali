...
.method public onBindViewHolder(Lcom/android/settings/fuelgauge/batterytip/HighUsageAdapter$ViewHolder;I)V
    ...
    .line 80
    iget-object v0, p1, Lcom/android/settings/fuelgauge/batterytip/HighUsageAdapter$ViewHolder;->appName:Landroid/widget/TextView;

    iget-object v1, p0, Lcom/android/settings/fuelgauge/batterytip/HighUsageAdapter;->mContext:Landroid/content/Context;

    iget-object v2, p2, Lcom/android/settings/fuelgauge/batterytip/AppInfo;->packageName:Ljava/lang/String;
    ...
    .line 81
    iget-wide v0, p2, Lcom/android/settings/fuelgauge/batterytip/AppInfo;->screenOnTimeMs:J
    ...
    .line 82
    iget-object p1, p1, Lcom/android/settings/fuelgauge/batterytip/HighUsageAdapter$ViewHolder;->appTime:Landroid/widget/TextView;

    iget-object v0, p0, Lcom/android/settings/fuelgauge/batterytip/HighUsageAdapter;->mContext:Landroid/content/Context;

    iget-wide v1, p2, Lcom/android/settings/fuelgauge/batterytip/AppInfo;->screenOnTimeMs:J

    long-to-double v1, v1

    const/4 p2, 0x0

    invoke-static {v0, v1, v2, p2}, Lcom/android/settingslib/utils/StringUtil;->formatElapsedTime(Landroid/content/Context;DZ)Ljava/lang/CharSequence;
...
.method public onCreateViewHolder(Landroid/view/ViewGroup;I)Lcom/android/settings/fuelgauge/batterytip/HighUsageAdapter$ViewHolder;
    ...
    .line 69
    iget-object p2, p0, Lcom/android/settings/fuelgauge/batterytip/HighUsageAdapter;->mContext:Landroid/content/Context;

    invoke-static {p2}, Landroid/view/LayoutInflater;->from(Landroid/content/Context;)Landroid/view/LayoutInflater;

    move-result-object p2

    const v0, 0x7f0d0031    # @layout/app_high_usage_item 'res/layout/app_high_usage_item.xml'

...
.method public constructor <init>(Landroid/app/Activity;Lcom/android/settingslib/core/lifecycle/Lifecycle;Lcom/android/settings/datausage/DataUsageSummary;)V
    ...
    invoke-direct {v0, p3}, Lcom/android/settingslib/NetworkPolicyEditor;-><init>(Landroid/net/NetworkPolicyManager;)V

    iput-object v0, p0, Lcom/android/settings/datausage/DataUsageSummaryPreferenceController;->mPolicyEditor:Lcom/android/settingslib/NetworkPolicyEditor;
...
.method private refreshDataplanInfo(Lcom/android/settingslib/net/DataUsageController$DataUsageInfo;)V
    ...
    iget-boolean v3, p0, Lcom/android/settings/datausage/DataUsageSummaryPreferenceController;->mHasMobileData:Z
    ...
    iput-object v2, p0, Lcom/android/settings/datausage/DataUsageSummaryPreferenceController;->mCarrierName:Ljava/lang/CharSequence;

    .line 265
    iget-object v2, p0, Lcom/android/settings/datausage/DataUsageSummaryPreferenceController;->mSubscriptionManager:Landroid/telephony/SubscriptionManager;

    invoke-virtual {v2, p1}, Landroid/telephony/SubscriptionManager;->getSubscriptionPlans(I)Ljava/util/List;
    ...
    invoke-static {v3, p1}, Lcom/android/settings/datausage/DataUsageSummaryPreferenceController;->getPrimaryPlan(Landroid/telephony/SubscriptionManager;I)Landroid/telephony/SubscriptionPlan;
    ...
    iput v2, p0, Lcom/android/settings/datausage/DataUsageSummaryPreferenceController;->mDataplanCount:I
    ...
    iput-wide v4, p0, Lcom/android/settings/datausage/DataUsageSummaryPreferenceController;->mDataplanSize:J

    .line 270
    iget-wide v4, p0, Lcom/android/settings/datausage/DataUsageSummaryPreferenceController;->mDataplanSize:J

    invoke-static {v4, v5}, Lcom/android/settings/datausage/DataUsageSummaryPreferenceController;->unlimited(J)Z
    ...
    .line 285
    invoke-virtual {v0, p1}, Landroid/telephony/SubscriptionManager;->createManageSubscriptionIntent(I)Landroid/content/Intent;
    ...
    iget v2, p0, Lcom/android/settings/datausage/DataUsageSummaryPreferenceController;->mDataplanCount:I

    invoke-virtual {v1, v2}, Ljava/lang/StringBuilder;->append(I)Ljava/lang/StringBuilder;

    const-string v2, " plans, dflt sub-id "
    ...
    iget-object p1, p0, Lcom/android/settings/datausage/DataUsageSummaryPreferenceController;->mManageSubscriptionIntent:Landroid/content/Intent;
...
.method public updateState(Landroid/support/v7/preference/Preference;)V
    ...
    .line 195
    invoke-virtual {p1, v7, v1}, Lcom/android/settings/datausage/DataUsageSummaryPreference;->setWifiMode(ZLjava/lang/String;)V
    ...
    const v2, 0x7f120393    # @string/cell_data_warning_and_limit '^1 data warning / ^2 data limit'
    ...
    .line 218
    invoke-virtual {p1, v0}, Lcom/android/settings/datausage/DataUsageSummaryPreference;->setLimitInfo(Ljava/lang/String;)V
    ...
    const v2, 0x7f120392    # @string/cell_data_warning '^1 data warning'
    ...
    const v2, 0x7f120390    # @string/cell_data_limit '^1 data limit'
    ...
    .line 231
    :cond_3
    invoke-virtual {p1, v1}, Lcom/android/settings/datausage/DataUsageSummaryPreference;->setLimitInfo(Ljava/lang/String;)V
    ...
    .line 199
    iget-object v0, v8, Lcom/android/settingslib/net/DataUsageController$DataUsageInfo;->period:Ljava/lang/String;

    invoke-virtual {p1, v6, v0}, Lcom/android/settings/datausage/DataUsageSummaryPreference;->setWifiMode(ZLjava/lang/String;)V

    .line 200
    invoke-virtual {p1, v1}, Lcom/android/settings/datausage/DataUsageSummaryPreference;->setLimitInfo(Ljava/lang/String;)V

    .line 201
    iget-wide v1, v8, Lcom/android/settingslib/net/DataUsageController$DataUsageInfo;->usageLevel:J
    ...
    .line 205
    iget-wide v1, v8, Lcom/android/settingslib/net/DataUsageController$DataUsageInfo;->cycleEnd:J

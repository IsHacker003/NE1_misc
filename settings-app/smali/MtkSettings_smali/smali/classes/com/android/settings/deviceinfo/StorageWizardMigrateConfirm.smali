...
.method protected onCreate(Landroid/os/Bundle;)V
    ...
    .line 52
    iget-object p1, p0, Lcom/android/settings/deviceinfo/StorageWizardMigrateConfirm;->mVolume:Landroid/os/storage/VolumeInfo;
    ...
    .line 53
    invoke-virtual {p0, v0}, Lcom/android/settings/deviceinfo/StorageWizardMigrateConfirm;->findFirstVolume(I)Landroid/os/storage/VolumeInfo;

    move-result-object p1

    iput-object p1, p0, Lcom/android/settings/deviceinfo/StorageWizardMigrateConfirm;->mVolume:Landroid/os/storage/VolumeInfo;
    ...
    invoke-virtual {p0, p1}, Lcom/android/settings/deviceinfo/StorageWizardMigrateConfirm;->setIcon(I)V

    .line 64
    const p1, 0x7f120d7e    # @string/storage_wizard_migrate_v2_title 'Move content to ^1?'
    ...
    invoke-virtual {p0, p1, v0}, Lcom/android/settings/deviceinfo/StorageWizardMigrateConfirm;->setHeaderText(I[Ljava/lang/CharSequence;)V
    ...
    invoke-virtual {p0, p1, v0}, Lcom/android/settings/deviceinfo/StorageWizardMigrateConfirm;->setBodyText(I[Ljava/lang/CharSequence;)V
    ...
    invoke-virtual {p1, v0}, Lcom/android/settings/deviceinfo/MigrateEstimateTask;->execute([Ljava/lang/Object;)Landroid/os/AsyncTask;

    .line 79
    const p1, 0x7f120d7c    # @string/storage_wizard_migrate_v2_later 'Move content later'

    new-array v0, v2, [Ljava/lang/CharSequence;

    invoke-virtual {p0, p1, v0}, Lcom/android/settings/deviceinfo/StorageWizardMigrateConfirm;->setBackButtonText(I[Ljava/lang/CharSequence;)V

    .line 80
    const p1, 0x7f120d7d    # @string/storage_wizard_migrate_v2_now 'Move content'

    new-array v0, v2, [Ljava/lang/CharSequence;

    invoke-virtual {p0, p1, v0}, Lcom/android/settings/deviceinfo/StorageWizardMigrateConfirm;->setNextButtonText(I[Ljava/lang/CharSequence;)V
...
.method public onNavigateNext(Landroid/view/View;)V
    ...
    .line 128
    const p1, 0x7f1200f2    # @string/another_migration_already_in_progress 'Another migration is already in progress.'
    ...
    .line 116
    iget-object v1, p0, Lcom/android/settings/deviceinfo/StorageWizardMigrateConfirm;->mVolume:Landroid/os/storage/VolumeInfo;

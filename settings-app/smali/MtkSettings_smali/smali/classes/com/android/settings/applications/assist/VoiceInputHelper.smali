...
.method public buildUi()V
    ...
    iput-object v0, p0, Lcom/android/settings/applications/assist/VoiceInputHelper;->mCurrentVoiceInteraction:Landroid/content/ComponentName;

    goto :goto_0

    .line 117
    :cond_0
    iput-object v1, p0, Lcom/android/settings/applications/assist/VoiceInputHelper;->mCurrentVoiceInteraction:Landroid/content/ComponentName;
    ...
    .line 124
    iget-object v2, p0, Lcom/android/settings/applications/assist/VoiceInputHelper;->mAvailableVoiceInteractions:Ljava/util/List;
    ...
    .line 126
    iget-object v5, p0, Lcom/android/settings/applications/assist/VoiceInputHelper;->mAvailableVoiceInteractions:Ljava/util/List;
    ...
    iget-object v7, p0, Lcom/android/settings/applications/assist/VoiceInputHelper;->mContext:Landroid/content/Context;
    ...
    invoke-direct {v6, v7, v8}, Landroid/service/voice/VoiceInteractionServiceInfo;-><init>(Landroid/content/pm/PackageManager;Landroid/content/pm/ServiceInfo;)V
    ...
    .line 135
    :cond_1
    iget-object v7, p0, Lcom/android/settings/applications/assist/VoiceInputHelper;->mAvailableInteractionInfos:Ljava/util/ArrayList;

    new-instance v8, Lcom/android/settings/applications/assist/VoiceInputHelper$InteractionInfo;
    ...
    invoke-direct {v8, v9, v6}, Lcom/android/settings/applications/assist/VoiceInputHelper$InteractionInfo;-><init>(Landroid/content/pm/PackageManager;Landroid/service/voice/VoiceInteractionServiceInfo;)V
    ...
    .line 139
    :cond_2
    iget-object v2, p0, Lcom/android/settings/applications/assist/VoiceInputHelper;->mAvailableInteractionInfos:Ljava/util/ArrayList;
    ...
    .line 147
    :cond_3
    iput-object v1, p0, Lcom/android/settings/applications/assist/VoiceInputHelper;->mCurrentRecognizer:Landroid/content/ComponentName;
    ...
    .line 154
    iget-object v5, p0, Lcom/android/settings/applications/assist/VoiceInputHelper;->mAvailableRecognition:Ljava/util/List;
    ...
    const-string v8, "android.speech"

    invoke-virtual {v6, v7, v8}, Landroid/content/pm/ServiceInfo;->loadXmlMetaData(Landroid/content/pm/PackageManager;Ljava/lang/String;)Landroid/content/res/XmlResourceParser;
    ...
    .line 171
    :try_start_1
    iget-object v8, p0, Lcom/android/settings/applications/assist/VoiceInputHelper;->mContext:Landroid/content/Context;
    ...
    .line 187
    sget-object v9, Lcom/android/internal/R$styleable;->RecognitionService:[I
    ...
    const-string v10, "No android.speech meta-data for "
    ...
    invoke-direct {v8, v6}, Lorg/xmlpull/v1/XmlPullParserException;-><init>(Ljava/lang/String;)V
    ...
    :goto_7
    :try_start_4
    const-string v9, "VoiceInputHelper"

    const-string v10, "error parsing recognition service meta-data"
    ...
    :cond_7
    :goto_a
    iget-object v6, p0, Lcom/android/settings/applications/assist/VoiceInputHelper;->mAvailableRecognizerInfos:Ljava/util/ArrayList;

    new-instance v7, Lcom/android/settings/applications/assist/VoiceInputHelper$RecognizerInfo;
    ...
    invoke-direct {v7, v9, v5, v8}, Lcom/android/settings/applications/assist/VoiceInputHelper$RecognizerInfo;-><init>(Landroid/content/pm/PackageManager;Landroid/content/pm/ServiceInfo;Ljava/lang/String;)V
    ...
    .line 204
    :cond_9
    iget-object v0, p0, Lcom/android/settings/applications/assist/VoiceInputHelper;->mAvailableRecognizerInfos:Ljava/util/ArrayList;

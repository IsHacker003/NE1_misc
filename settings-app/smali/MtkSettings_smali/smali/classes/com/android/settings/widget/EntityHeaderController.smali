...
.method private constructor <init>(Landroid/app/Activity;Landroid/app/Fragment;Landroid/view/View;)V
    ...
    const p2, 0x7f0d0143    # @layout/settings_entity_header 'res/layout/settings_entity_header.xml'
...
.method static synthetic access$200(Lcom/android/settings/widget/EntityHeaderController;)Landroid/app/Fragment;
    ...
    .line 58
    iget-object p0, p0, Lcom/android/settings/widget/EntityHeaderController;->mFragment:Landroid/app/Fragment;
...
.method private bindButton(Landroid/widget/ImageButton;I)V
    ...
    .line 343
    :pswitch_0
    iget-object p2, p0, Lcom/android/settings/widget/EntityHeaderController;->mEditRuleNameOnClickListener:Landroid/view/View$OnClickListener;
    ...
    .line 346
    :cond_1
    const p2, 0x7f080135    # @drawable/ic_mode_edit 'res/drawable/ic_mode_edit.xml'
    ...
    .line 356
    :cond_2
    new-instance p2, Lcom/android/settings/widget/EntityHeaderController$2;

    invoke-direct {p2, p0}, Lcom/android/settings/widget/EntityHeaderController$2;-><init>(Lcom/android/settings/widget/EntityHeaderController;)V
...
.method public bindHeaderButtons()Lcom/android/settings/widget/EntityHeaderController;
    ...
    const v1, 0x7f0a0137    # @id/entity_header_content
...
.method public done(Landroid/app/Activity;Z)Landroid/view/View;
    ...
    .line 252
    :cond_0
    const p1, 0x7f0a013c    # @id/entity_header_title
    ...
    .line 253
    const p1, 0x7f0a013b    # @id/entity_header_summary
    ...
    .line 254
    const p1, 0x7f0a013a    # @id/entity_header_second_summary
    ...
    .line 256
    const p1, 0x7f0a01b7    # @id/install_type
    ...
    const v1, 0x7f120759    # @string/install_type_instant 'Instant app'
...
.method public done(Landroid/app/Activity;Landroid/content/Context;)Lcom/android/settings/applications/LayoutPreference;
    ...
    invoke-direct {v0, p2, p1}, Lcom/android/settings/applications/LayoutPreference;-><init>(Landroid/content/Context;Landroid/view/View;)V

    .line 236
    const/16 p1, -0x3e8

    invoke-virtual {v0, p1}, Lcom/android/settings/applications/LayoutPreference;->setOrder(I)V

    .line 237
    const/4 p1, 0x0

    invoke-virtual {v0, p1}, Lcom/android/settings/applications/LayoutPreference;->setSelectable(Z)V

    .line 238
    const-string p1, "pref_app_header"

    invoke-virtual {v0, p1}, Lcom/android/settings/applications/LayoutPreference;->setKey(Ljava/lang/String;)V
...
.method public styleActionBar(Landroid/app/Activity;)Lcom/android/settings/widget/EntityHeaderController;
    ...
    const-string v0, "No activity, cannot style actionbar."
    ...
    const-string v0, "No actionbar, cannot style actionbar."
    ...
    invoke-virtual {v0, p1}, Landroid/app/ActionBar;->setElevation(F)V

    .line 322
    iget-object p1, p0, Lcom/android/settings/widget/EntityHeaderController;->mRecyclerView:Landroid/support/v7/widget/RecyclerView;

    if-eqz p1, :cond_2

    iget-object p1, p0, Lcom/android/settings/widget/EntityHeaderController;->mLifecycle:Lcom/android/settingslib/core/lifecycle/Lifecycle;

    if-eqz p1, :cond_2

    .line 323
    iget-object p1, p0, Lcom/android/settings/widget/EntityHeaderController;->mActivity:Landroid/app/Activity;
    ...
    invoke-static {p1, v0, v1}, Lcom/android/settings/widget/ActionBarShadowController;->attachToRecyclerView(Landroid/app/Activity;Lcom/android/settingslib/core/lifecycle/Lifecycle;Landroid/support/v7/widget/RecyclerView;)Lcom/android/settings/widget/ActionBarShadowController;

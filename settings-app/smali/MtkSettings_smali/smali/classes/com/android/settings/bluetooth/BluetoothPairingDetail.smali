...
.method public getHelpResource()I
    ...
    .line 190
    const v0, 0x7f1206f8    # @string/help_url_bluetooth ''
...
.method protected getPreferenceScreenResId()I
    ...
    .line 200
    const v0, 0x7f150028    # @xml/bluetooth_pairing_detail 'res/xml/bluetooth_pairing_detail.xml'
...
.method public onActivityCreated(Landroid/os/Bundle;)V
    ...
    invoke-direct {p1, v0, v1}, Lcom/android/settings/bluetooth/AlwaysDiscoverable;-><init>(Landroid/content/Context;Lcom/android/settingslib/bluetooth/LocalBluetoothAdapter;)V
...
.method public onAttach(Landroid/content/Context;)V
    ...
    invoke-virtual {p0, p1}, Lcom/android/settings/bluetooth/BluetoothPairingDetail;->use(Ljava/lang/Class;)Lcom/android/settingslib/core/AbstractPreferenceController;

    move-result-object p1

    check-cast p1, Lcom/android/settings/bluetooth/BluetoothDeviceRenamePreferenceController;

    invoke-virtual {p1, p0}, Lcom/android/settings/bluetooth/BluetoothDeviceRenamePreferenceController;->setFragment(Landroid/app/Fragment;)V
...
.method updateContent(I)V
    ...
    .line 148
    :cond_0
    iget-object p1, p0, Lcom/android/settings/bluetooth/BluetoothPairingDetail;->mDevicePreferenceMap:Ljava/util/WeakHashMap;

    invoke-virtual {p1}, Ljava/util/WeakHashMap;->clear()V

    .line 149
    iget-object p1, p0, Lcom/android/settings/bluetooth/BluetoothPairingDetail;->mLocalAdapter:Lcom/android/settingslib/bluetooth/LocalBluetoothAdapter;
    ...
    const v0, 0x7f1202f8    # @string/bluetooth_preference_found_media_devices 'Available devices'
    ...
    invoke-virtual {p0, p1, v0, v1, v2}, Lcom/android/settings/bluetooth/BluetoothPairingDetail;->addDeviceCategory(Landroid/support/v7/preference/PreferenceGroup;ILcom/android/settingslib/bluetooth/BluetoothDeviceFilter$Filter;Z)V
    ...
    invoke-virtual {p0, p1}, Lcom/android/settings/bluetooth/BluetoothPairingDetail;->updateFooterPreference(Landroid/support/v7/preference/Preference;)V

...
.method private init()V
    ...
    .line 92
    new-instance v5, Landroid/support/v7/preference/ListPreference;

    invoke-virtual {p0}, Lcom/android/settings/fuelgauge/InactiveApps;->getPrefContext()Landroid/content/Context;

    move-result-object v6

    invoke-direct {v5, v6}, Landroid/support/v7/preference/ListPreference;-><init>(Landroid/content/Context;)V
    ...
    invoke-virtual {v5, v6}, Landroid/support/v7/preference/ListPreference;->setTitle(Ljava/lang/CharSequence;)V
    ...
    invoke-virtual {v5, v2}, Landroid/support/v7/preference/ListPreference;->setIcon(Landroid/graphics/drawable/Drawable;)V

    .line 95
    invoke-virtual {v5, v4}, Landroid/support/v7/preference/ListPreference;->setKey(Ljava/lang/String;)V

    .line 96
    sget-object v2, Lcom/android/settings/fuelgauge/InactiveApps;->SETTABLE_BUCKETS_NAMES:[Ljava/lang/CharSequence;

    invoke-virtual {v5, v2}, Landroid/support/v7/preference/ListPreference;->setEntries([Ljava/lang/CharSequence;)V

    .line 97
    sget-object v2, Lcom/android/settings/fuelgauge/InactiveApps;->SETTABLE_BUCKETS_VALUES:[Ljava/lang/CharSequence;

    invoke-virtual {v5, v2}, Landroid/support/v7/preference/ListPreference;->setEntryValues([Ljava/lang/CharSequence;)V

    .line 98
    invoke-direct {p0, v5}, Lcom/android/settings/fuelgauge/InactiveApps;->updateSummary(Landroid/support/v7/preference/ListPreference;)V
    ...
    .line 101
    invoke-virtual {v0, v5}, Landroid/support/v7/preference/PreferenceGroup;->addPreference(Landroid/support/v7/preference/Preference;)Z
...
.method private updateSummary(Landroid/support/v7/preference/ListPreference;)V
    ...
    const v2, 0x7f120ce8    # @string/standby_bucket_summary 'App standby state: %s'
...
.method public onCreate(Landroid/os/Bundle;)V
    ...
    .line 70
    const p1, 0x7f150062    # @xml/inactive_apps 'res/xml/inactive_apps.xml'
...
.method public onPreferenceChange(Landroid/support/v7/preference/Preference;Ljava/lang/Object;)Z
    ...
    invoke-direct {p0, p1}, Lcom/android/settings/fuelgauge/InactiveApps;->updateSummary(Landroid/support/v7/preference/ListPreference;)V
